...
public class Day0321_hw {
	...
	public static void main(String[] args) {
		...
		int[] a = {10, 20, 30, 40, 50};
			for(int b = 0; b < 5; b++)
			{
				System.out.println("score["+b+"] = "+a[0]);
			}
...
//			for(byte d = 0; d < 5; d++)
		...
		m[3] = (float) 12.56;
		m[4] = (float) 15.700001;
		float[] n = {(float) 3.14, (float) 6.28, (float) 9.42, (float) 12.56, (float) 15.700001};
